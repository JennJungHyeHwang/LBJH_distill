...
ggplot() +
  geom_point(Average_years_of_education2, 
       mapping= aes(x = Continent, y = Year_of_2020 , color = Continent))+ ggtitle ("Average years of education for each Continent") + labs(y= "Average Years of Education Provided")
```
...
ggplot() +
  geom_point(income_mask_sah, 
       mapping= aes(x = Country, y = Mask_Mandates, color= Mask_Mandates))
```
